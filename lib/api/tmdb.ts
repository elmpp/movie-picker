...
import movieDbModule, { Callback, Movie } from 'moviedb'
...
export const tmdb = {
  ...
  getPopularTvs: (callback: Callback<Movie>) => movieDb.miscPopularTvs(callback), // api browser - https://tinyurl.com/rtj5yqb
}
